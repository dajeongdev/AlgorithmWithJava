...
public class 그림확대 {
    ...
    public String[] solution(String[] picture, int k) {
        ...
        for (int i = 0; i < picture.length; i++) {
            ...
            for (int j = 0; j < picture[i].length(); j++)
                temp += String.valueOf(picture[i].charAt(j)).repeat(k);
    ...
    public static void main(String[] args) {
        ...
        String[] pictures1 = {".xx...xx.", "x..x.x..x", "x...x...x", ".x.....x.", "..x...x..", "...x.x...", "....x...."};
        String[] pictures2 = {"x.x", ".x.", "x.x"};

        for (String s : T.solution(pictures1, 2))
            System.out.println(s);

        for (String s : T.solution(pictures2, 3))
            System.out.println(s);
