...
public class 문자열뒤집기 {
    ...
    public String solution(String my_string, int s, int e) {
        String reverse = "";
        for (int i = e; i >= s; i--) reverse += my_string.charAt(i);
        return my_string.substring(0, s) + reverse + my_string.substring(e+1);
    }

    public String otherSolution(String my_string, int s, int e) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution("Stanley1yelnatS", 4, 10));
        System.out.println(T.otherSolution("Progra21Sremm3", 6, 12));
        System.out.println(T.otherSolution("Stanley1yelnatS", 4, 10));
    }
}
