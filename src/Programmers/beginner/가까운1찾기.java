...
public class 가까운1찾기 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution(arr1, 1));
        System.out.println(T.solution(arr2, 4));
        System.out.println(T.solution(arr3, 3));
        System.out.println(T.otherSolution(arr1, 1));
        System.out.println(T.otherSolution(arr2, 4));
        System.out.println(T.otherSolution(arr3, 3));
    }
}
