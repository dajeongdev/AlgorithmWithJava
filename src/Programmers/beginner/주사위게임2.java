...
public class 주사위게임2 {
     ...
     * 입출력 예 #2
     * 예제 2번에서 두 주사위 숫자만 같으므로 (5 + 3 + 3) × (25 + 9 + 9) = 11 × 43 = 473점을 얻습니다. 따라서 473을 return 합니다.
     * 입출력 예 #3
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution(2, 6, 1));
        System.out.println(T.solution(5, 3, 3));
        System.out.println(T.solution(4, 4, 4));
    }
}
