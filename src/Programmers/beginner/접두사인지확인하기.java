...
public class 접두사인지확인하기 {
    ...
    public static void main(String[] args) {
        접두사인지확인하기 T = new 접두사인지확인하기();

        System.out.println(T.solution("banana", "ban"));
        System.out.println(T.solution("banana", "nan"));
        System.out.println(T.solution("banana", "abcd"));
        System.out.println(T.solution("banana", "bananan"));
    }
}
