...
public class 숫자9로나눈나머지 {
    ...
    public static void main(String[] args) {
        숫자9로나눈나머지 T = new 숫자9로나눈나머지();

        System.out.println(T.solution("123"));
        System.out.println(T.solution("78720646226947352489"));
        System.out.println(T.otherSolution("123"));
        System.out.println(T.otherSolution("78720646226947352489"));
    }
}
