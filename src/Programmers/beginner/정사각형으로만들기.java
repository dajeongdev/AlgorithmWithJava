...
public class 정사각형으로만들기 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.deepToString(T.solution(arr2)));
        System.out.println(Arrays.deepToString(T.solution(arr3)));
        System.out.println(Arrays.deepToString(T.otherSolution(arr1)));
        System.out.println(Arrays.deepToString(T.otherSolution(arr2)));
        System.out.println(Arrays.deepToString(T.otherSolution(arr3)));
    }
}
