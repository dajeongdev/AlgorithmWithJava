...
public class my_string {
    ...
    public static void main(String[] args) {
        my_string T = new my_string();

        System.out.println(T.solution("masterpiece"));
        System.out.println(T.solution("programmers"));
        System.out.println(T.solution("jerry"));
        System.out.println(T.solution("burn"));
    }
}
