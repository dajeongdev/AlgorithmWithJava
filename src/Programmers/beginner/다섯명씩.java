...
public class 다섯명씩 {
    ...
    public static void main(String[] args) {
        ...
        String[] names2 = {"nami", "ahri", "jayce", "garen", "ivern", "vex", "jinx", "ahri", "jayce", "garen", "ivern"};
        System.out.println(Arrays.toString(T.solution(names1)));
        System.out.println(Arrays.toString(T.solution(names2)));
    }
}
