...
public class 꼬리문자열 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution(str_list1, "ef"));
        System.out.println(T.solution(str_list2, "c"));
        System.out.println(T.otherSolution(str_list1, "ef"));
        System.out.println(T.otherSolution(str_list2, "c"));
    }
}
