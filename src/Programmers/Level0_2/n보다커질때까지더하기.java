...
public class n보다커질때까지더하기 {
    ...
    public static void main(String[] args) {
        n보다커질때까지더하기 T = new n보다커질때까지더하기();

        int[] numbers1 = {34, 5, 71, 29, 100, 34};
        int[] numbers2 = {58, 44, 27, 10, 100};

        System.out.println(T.solution(numbers1, 123));
        System.out.println(T.solution(numbers2, 139));
        System.out.println(T.otherSolution(numbers1, 123));
        System.out.println(T.otherSolution(numbers2, 139));
    }
}
