...
public class 배열만들기3 {
    ...
    public int[] otherSolution(int[] arr, int[][] intervals) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(T.solution(arr, intervals)));
        System.out.println(Arrays.toString(T.otherSolution(arr, intervals)));
    }
}
