...
public class 간단한식계산하기 {
    ...
    public int solution(String binomial) {
        ...
        int answer = 0, a = Integer.parseInt(split[0]), b = Integer.parseInt(split[2]);
        String op = split[1];
    ...
    public static void main(String[] args) {
        간단한식계산하기 T = new 간단한식계산하기();

        System.out.println(T.solution("43 + 12"));
        System.out.println(T.solution("0 - 7777"));
        System.out.println(T.solution("40000 * 40000"));
    }
}
