...
public class 커피심부름 {
    ...
    public int solution(String[] order) {
        return Arrays.stream(order).map(coffee -> coffee.contains("latte") ? "5000" : "4500").mapToInt(Integer::parseInt).sum();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution(order1));
        System.out.println(T.solution(order2));
    }
}
