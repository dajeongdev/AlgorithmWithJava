...
public class 배열에서문자열대소문자변환하기 {
    ...
    public String[] solution(String[] strArr) {
        for (int i = 0; i < strArr.length; i++) {
            String str = strArr[i];
            strArr[i] = (i % 2 != 0) ? str.toUpperCase() : str.toLowerCase();
        }
        return strArr;
    }
    ...
    public static void main(String[] args) {
        배열에서문자열대소문자변환하기 T = new 배열에서문자열대소문자변환하기();

        String[] strArr1 = {"AAA","BBB","CCC","DDD"};
        String[] strArr2 = {"aBc","AbC"};

        System.out.println(Arrays.toString(T.solution(strArr1)));
        System.out.println(Arrays.toString(T.solution(strArr2)));
        System.out.println(Arrays.toString(T.otherSolution(strArr1)));
        System.out.println(Arrays.toString(T.otherSolution(strArr2)));
    }
}
