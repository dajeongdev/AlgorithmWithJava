...
public class 세로읽기 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution("ihrhbakrfpndopljhygc", 4, 2));
        System.out.println(T.solution("programmers", 1, 1));
        System.out.println(T.otherSolution("ihrhbakrfpndopljhygc", 4, 2));
        System.out.println(T.otherSolution("programmers", 1, 1));
    }
}
