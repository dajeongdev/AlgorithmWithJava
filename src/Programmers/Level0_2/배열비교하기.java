...
public class 배열비교하기 {
    ...
    public int otherSolution(int[] arr1, int[] arr2) {
        ...
        return answer != 0 ? answer : Integer.compare(IntStream.of(arr1).sum(), IntStream.of(arr2).sum());
    }
    ...
    public static void main(String[] args) {
        ...
        int[] arr1_1 = {49, 13};
        int[] arr1_2 = {100, 17, 84, 1};
        int[] arr1_3 = {1, 2, 3, 4, 5};
        int[] arr2_1 = {70, 11, 2};
        int[] arr2_2 = {55, 12, 65, 36};
        int[] arr2_3 = {3, 3, 3, 3, 3};

        System.out.println(T.solution(arr1_1, arr2_1));
        System.out.println(T.solution(arr1_2, arr2_2));
        System.out.println(T.solution(arr1_3, arr2_3));
        System.out.println(T.otherSolution(arr1_1, arr2_1));
        System.out.println(T.otherSolution(arr1_2, arr2_2));
        System.out.println(T.otherSolution(arr1_3, arr2_3));
    }
}
