...
public class 문자열잘라서정렬하기 {
    ...
    public static void main(String[] args) {
        문자열잘라서정렬하기 T = new 문자열잘라서정렬하기();

        System.out.println(Arrays.toString(T.solution("axbxcxdx")));
        System.out.println(Arrays.toString(T.solution("dxccxbbbxaaaa")));
        System.out.println(Arrays.toString(T.solution("dxccxbbbxxaaaa")));
    }
}
