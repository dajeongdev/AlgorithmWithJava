...
public class 음양더하기 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution(absolutes1, signs1));
        System.out.println(T.solution(absolutes2, signs2));
        System.out.println(T.otherSolution(absolutes1, signs1));
        System.out.println(T.otherSolution(absolutes2, signs2));
    }
}
