...
public class 없는숫자더하기 {
    ...
    public int solution(int[] numbers) {
        return IntStream.rangeClosed(0, 9).filter(i -> Arrays.stream(numbers).noneMatch(s -> s == i)).sum();
    }

    // 계수 정렬: 각 항목의 개수를 카운트하여 정렬하는 알고리즘
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.otherSolution(numbers1));
        System.out.println(T.otherSolution(numbers2));
    }
}
