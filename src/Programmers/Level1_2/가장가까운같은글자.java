...
public class 가장가까운같은글자 {
    ...
    public int[] solution(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            answer[i] = !tempStr.contains(String.valueOf(tempChar)) ? -1 : i - tempStr.lastIndexOf(tempChar);
        }
        return answer;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(T.otherSolution("banana")));
        System.out.println(Arrays.toString(T.otherSolution("foobar")));
    }
}
