...
public class 비밀지도 {
    ...
    public String[] solution(int n, int[] arr1, int[] arr2) {
        ...
        for (int i = 0; i < arr1.length; i++) {
            ...
            answer[i] = convert.replace("0", " ").replace("1", "#");
        }
        return answer;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(T.solution(5, arr1_1, arr2_1)));
        System.out.println(Arrays.toString(T.solution(6, arr1_2, arr2_2)));
        System.out.println(Arrays.toString(T.otherSolution(5, arr1_1, arr2_1)));
        System.out.println(Arrays.toString(T.otherSolution(6, arr1_2, arr2_2)));
    }
}
