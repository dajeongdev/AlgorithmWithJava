...
public class 문자열정렬하기_1 {
    ...
    public int[] streamUsedSolution(String myString) {
        return Arrays.stream(myString.replaceAll("[A-Z|a-z]", "").split("")).sorted().mapToInt(Integer::parseInt).toArray();
    }

    public static void main(String[] args) {
        문자열정렬하기_1 T = new 문자열정렬하기_1();

        System.out.println(Arrays.toString(T.solution("hi12392")));
        System.out.println(Arrays.toString(T.solution("p2o4i8gj2")));
        System.out.println(Arrays.toString(T.solution("abcde0")));
    }
}
