...
public class 로또의최고순위와최저순위 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(T.solution(lottos1, winNums1)));
        System.out.println(Arrays.toString(T.solution(lottos2, winNums2)));
        System.out.println(Arrays.toString(T.solution(lottos3, winNums3)));
    }
}
