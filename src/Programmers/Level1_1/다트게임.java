...
public class 다트게임 {
    ...
    public int solution(String dartResult) {
        ...
        for (int i = 0; i < dartResult.length(); i++) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                if (c == 'S') {
                    dartScore[index++] = (int) Math.pow(num, 1);
                } else if (c == 'D') {
                    dartScore[index++] = (int) Math.pow(num, 2);
                } else {
                    dartScore[index++] = (int) Math.pow(num, 3);
                }
                temp = "";
            } else {
                if (c == '#') {
                    ...
                    dartScore[index - 1] *= 2;
                    if (index - 2 >= 0) dartScore[index - 2] *= 2;
                }
            }
        }
        return dartScore[0] + dartScore[1] + dartScore[2];
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution(dartResult1));
    }
}