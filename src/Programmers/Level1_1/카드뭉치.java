...
public class 카드뭉치 {
    ...
    public String solution(String[] cards1, String[] cards2, String[] goal) {
        String answer = "Yes";
        for (int i = 0, idx1 = 0, idx2 = 0; i < goal.length; i++) {
    ...
    public static void main(String[] args) {
        ...
        String[] cards1_3 = {"i", "drink", "water", "now"};
        String[] cards2_1 = {"want", "to"};
        String[] goal1 = {"i", "want", "to", "drink", "water"};

        System.out.println(T.solution(cards1_1, cards2_1, goal1));
        System.out.println(T.solution(cards1_2, cards2_1, goal1));
        System.out.println(T.solution(cards1_3, cards2_1, goal1));
    }
}
