...
public class 기사단원의무기 {
    ...
    public int otherSolution(int number, int limit, int power) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.otherSolution(5, 3, 2));
        System.out.println(T.otherSolution(10, 3, 2));
    }
}
