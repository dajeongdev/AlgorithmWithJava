...
public class 명예의전당_1 {
    ...
    public static int[] otherSolution(int k, int[] score) {
        int[] answer = new int[score.length];
    ...
    public static void main(String[] args) {
        명예의전당_1 T = new 명예의전당_1();

        int[] score1 = {10, 100, 20, 150, 1, 100, 200};
        int[] score2 = {0, 300, 40, 300, 20, 70, 150, 50, 500, 1000};

        System.out.println(Arrays.toString(T.solution(3, score1)));
        System.out.println(Arrays.toString(T.solution(4, score2)));

        System.out.println(Arrays.toString(T.otherSolution(3, score1)));
        System.out.println(Arrays.toString(T.otherSolution(4, score2)));
    }
}
