...
public class 추억점수 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(T.solution(name1, yearning1, photo1)));
//        System.out.println(Arrays.toString(T.solution(name2, yearning2, photo2)));
//        System.out.println(Arrays.toString(T.solution(name3, yearning3, photo3)));
    }
}
