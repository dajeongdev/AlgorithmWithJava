...
public class 과일장수 {
    ...
    public int solution(int k, int m, int[] score) {
        ...
        for (int i = score.length - 1; i >= 0; i--) {
            // ((score.length - i) % m == 0) -> 최저 점수
            if ((score.length - i) % m == 0) answer += score[i] * m;
        }
        return answer;
    }

    public int otherSolution(int k, int m, int[] score) {
        int answer = 0;
        Arrays.sort(score);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(T.solution(3, 4, score1));
        System.out.println(T.solution(4, 3, score2));

        System.out.println(T.otherSolution(3, 4, score1));
        System.out.println(T.otherSolution(4, 3, score2));
    }
}
