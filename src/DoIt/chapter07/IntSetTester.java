...
public class IntSetTester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("집합 s1에 15는 " + (s1.contains(15) ? "포함됩니다." : "포함되지 되지 않습니다."));
        System.out.println("집합 s2에 25는 " + (s2.contains(25) ? "포함됩니다." : "포함되지 되지 않습니다."));
